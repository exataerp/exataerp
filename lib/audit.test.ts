...
describe("Auditoria do Sistema", () => {
  ...
  it("traduz códigos internos da auditoria integralmente para Português BR", () => {
    ...
    assert.equal(auditActionLabel("production_report_started"), "Apontamento de produção iniciado")
    ...
    assert.equal(auditOriginLabel(undefined), "Origem não registrada (legado)")
